...
- [API Patterns](./api-patterns) - Instrument APIs automatically
- [Message Queues](./message-queues) - Trace async workflows
- [Dashboards](../frontend/dashboards) - Visualize metrics in Grafana
- [Deploying Applications](./deploying-applications) - Deploy LGTM stack

## References

- [Full Skill Documentation](https://github.com/ancoleman/ai-design-components/tree/main/skills/observability)
