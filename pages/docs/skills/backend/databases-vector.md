...
- [AI Chat](../frontend/ai-chat) - Frontend chat interface powered by vector DB RAG
...
- [Relational Databases](./databases-relational) - Hybrid approach using pgvector

## References

- [Full Skill Documentation](https://github.com/ancoleman/ai-design-components/tree/main/skills/databases-vector)
