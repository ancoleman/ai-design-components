...
**With Other Skills:**
- `kubernetes-operations` - Cluster setup, network policies, ingress
...
- `infrastructure-as-code` - Helm charts, Terraform for mesh deployment
...
- [Full Master Plan (init.md)](https://github.com/ancoleman/ai-design-components/blob/main/skills/service-mesh/init.md)
- Related: `kubernetes-operations`, `security-hardening`, `observability`
