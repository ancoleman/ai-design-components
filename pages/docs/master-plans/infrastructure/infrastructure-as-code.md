...
- [Full Master Plan (init.md)](https://github.com/ancoleman/ai-design-components/blob/main/skills/infrastructure-as-code/init.md)
- Related: `kubernetes-operations`, `building-ci-pipelines`, `secret-management`
