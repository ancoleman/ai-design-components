...
**With Other Skills:**
- `infrastructure-as-code` - Terraform provisions, Ansible configures
- `kubernetes-operations` - Ansible deploys K8s clusters (kubespray)
...
- [Full Master Plan (init.md)](https://github.com/ancoleman/ai-design-components/blob/main/skills/configuration-management/init.md)
- Related: `infrastructure-as-code`, `kubernetes-operations`, `secret-management`
