...
**With Other Skills:**
- `infrastructure-as-code` - Terraform/Pulumi for network provisioning
- `kubernetes-operations` - Network policies, service mesh integration
- `load-balancing-patterns` - LB networking, global load balancing
- `security-hardening` - Security groups, NACLs, firewall rules
- `dns-management` - DNS architecture, split-horizon DNS
- `observability` - VPC flow logs, network monitoring
...
- [Full Master Plan (init.md)](https://github.com/ancoleman/ai-design-components/blob/main/skills/network-architecture/init.md)
- Related: `infrastructure-as-code`, `security-hardening`, `load-balancing-patterns`
