...
**With Other Skills:**
- `configuration-management` - Automate Linux configuration at scale (Ansible)
- `security-hardening` - Apply CIS benchmarks, SELinux, AppArmor
- `kubernetes-operations` - Understand K8s node OS layer
- `shell-scripting` - Automate administrative tasks
- `observability` - Integrate with monitoring (Prometheus, Grafana)
...
- [Full Master Plan (init.md)](https://github.com/ancoleman/ai-design-components/blob/main/skills/linux-administration/init.md)
- Related: `configuration-management`, `security-hardening`, `shell-scripting`
