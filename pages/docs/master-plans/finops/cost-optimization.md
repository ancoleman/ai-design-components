...
- `kubernetes-operations` - K8s rightsizing, VPA, cluster autoscaling
...
- [Full Master Plan](https://github.com/ancoleman/ai-design-components/blob/main/skills/cost-optimization/init.md)
