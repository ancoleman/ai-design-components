#!/bin/bash
#
# AI Design Components - Skillchain Command Installer
#
...
SKILLCHAIN_SOURCE="$SCRIPT_DIR/skillchain.md"
...
echo -e "${BLUE}╔══════════════════════════════════════════════════════════════╗${NC}"
echo -e "${BLUE}║     AI Design Components - Skillchain Command Installer      ║${NC}"
echo -e "${BLUE}╚══════════════════════════════════════════════════════════════╝${NC}"
echo ""

# Check if source file exists
if [ ! -f "$SKILLCHAIN_SOURCE" ]; then
    echo -e "${RED}Error: skillchain.md not found at $SKILLCHAIN_SOURCE${NC}"
...
if [ -f "$CLAUDE_COMMANDS_DIR/skillchain.md" ]; then
    echo -e "${YELLOW}Existing skillchain.md found. Updating...${NC}"
fi

# Copy skillchain.md
echo -e "${YELLOW}Installing skillchain command...${NC}"
cp "$SKILLCHAIN_SOURCE" "$CLAUDE_COMMANDS_DIR/skillchain.md"

# Verify installation
if [ -f "$CLAUDE_COMMANDS_DIR/skillchain.md" ]; then
    echo ""
    echo -e "${GREEN}✅ Skillchain command installed successfully!${NC}"
    echo ""
    echo -e "Location: ${BLUE}$CLAUDE_COMMANDS_DIR/skillchain.md${NC}"
    echo ""
